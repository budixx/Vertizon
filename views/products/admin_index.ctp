<div class="products index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Type','ptype_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Html->link($product['Product']['basename'],$this->Media->urls($product['Product']['file']),array('class' => 'pict','rel' => 'group')); ?>&nbsp;</td>
		<td class="actions">
