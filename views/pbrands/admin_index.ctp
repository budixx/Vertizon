<div class="pbrands index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Category','pcategory_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Html->link($pbrand['Pbrand']['basename'],$this->Media->urls($pbrand['Pbrand']['file']),array('class' => 'pict','rel' => 'group')); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('New %s', true), __('Brand', true)), array('action' => 'add')); ?></li>
	</ul>
</div>